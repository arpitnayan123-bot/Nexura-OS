...
export const metadata: Metadata = {
  ...
  description: "The story of Arpit Nayan — a student from Bihar who walked into a hospital and decided to build the operating system Indian healthcare deserves.",
};
