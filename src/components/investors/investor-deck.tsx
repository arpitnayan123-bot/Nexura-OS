    ...
    <nav className="fixed top-0 inset-x-0 z-50 backdrop-blur-xl bg-[#0A0A0A]/70 border-b border-white/5">
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 flex items-center justify-between h-14">
        ...
        <div className="flex items-center gap-4 text-xs">
          ...
          <Link href="/compliance" className="text-white/60 hover:text-white">
            Compliance
          </Link>
  ...
  return (
    <section className="relative pt-32 pb-24 px-4 sm:px-6 lg:px-8 overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div
          aria-hidden
          className="aurora-gold top-[-20%] left-1/2 h-[26rem] w-[44rem] -translate-x-1/2 opacity-40"
        />
      </div>
      <div ref={ref} className="relative mx-auto max-w-4xl text-center">
        ...
        >
          Building the OS for <span className="text-gold-gradient">Indian healthcare.</span>
        </motion.h1>
        <motion.p
          initial={{ opacity: 0, y: 20 }}
          animate={inView ? { opacity: 1, y: 0 } : {}}
        ...
        >
          Nexura OS is the first unified, AI-native healthcare platform for India — connecting
          hospitals, clinics, pharmacies, and 1.4 billion patients through one warm, intelligent
          ecosystem.
        </motion.p>
        <motion.div
          initial={{ opacity: 0, y: 20 }}
        ...
        >
          ...
          <a
            href="#ask"
            className="btn-glass-lux h-11 rounded-full border-white/20 bg-white/5 px-5 text-sm font-semibold text-white"
          >
            Investment ask →
          </a>
        </motion.div>
        ...
        {[
          {
            icon: Building2,
            title: "Hospital OS",
            desc: "18-module HMS with AI clinical intelligence, NEWS2, NABH compliance",
            color: "#B8860B",
          },
          {
            icon: Stethoscope,
            title: "Clinic OS",
            desc: "HealthPlix-style EMR with SOAP, drug autocomplete, ABHA lookup (simulated)",
            color: "#A16207",
          },
          {
            icon: Pill,
            title: "Pharmacia",
            desc: "AI pharmacy POS with voice billing, Rx OCR, GST e-invoice, Schedule H",
            color: "#F59E0B",
          },
          {
            icon: HeartPulse,
            title: "Patient Portal",
            desc: "Unified health record + blood test at home with AI interpretation",
            color: "#0EA5E9",
          },
          {
            icon: MessageCircle,
            title: "Connect",
            desc: "Doctor-patient chat, voice, video across all products",
            color: "#10B981",
          },
          {
            icon: Sparkles,
            title: "Know Your Health",
            desc: "15 AI tools — symptom checker, derma scan, diet planner, X-ray reader",
            color: "#9DB89E",
          },
        ].map((p, i) => (
          <motion.div
...
function Market() {
  return (
    <Section id="market" className="border-t border-white/5">
      ...
      <SectionTitle>
        $372B Indian healthcare. $48B digital health. We're building the rails.
      </SectionTitle>
      <div className="grid lg:grid-cols-3 gap-6 mb-12">
        ...
        <div className="rounded-2xl border border-white/10 bg-white/[0.03] p-6">
          ...
          <p className="text-xs text-white/30 mt-2">
            70,000 hospitals + 3M clinics + 850K pharmacies.
          </p>
        </div>
        <div className="rounded-2xl border border-white/10 bg-white/[0.03] p-6">
          ...
          <p className="text-xs text-white/30 mt-2">
            15,000 hospitals + 100,000 clinics + 200,000 pharmacies.
          </p>
        </div>
      </div>
      <div className="rounded-2xl border border-white/10 bg-gradient-to-br from-[#A16207]/10 to-[#7A9A7B]/5 p-8">
        ...
        <p className="text-white/60 text-sm leading-relaxed mb-4">
          ...
          must be digital. This is a forced market creation — and Nexura OS is built natively for
          it.
        </p>
        <div className="grid grid-cols-3 gap-4">
          <div>
            <p className="font-display text-2xl font-bold text-white">680M+</p>
            <p className="text-xs text-white/40">ABHA IDs created</p>
          </div>
          <div>
            <p className="font-display text-2xl font-bold text-white">₹41B</p>
            <p className="text-xs text-white/40">Govt digital health budget</p>
          </div>
          <div>
            <p className="font-display text-2xl font-bold text-white">2026</p>
            <p className="text-xs text-white/40">Mandatory compliance year</p>
          </div>
        </div>
      </div>
    </Section>
...
function Traction() {
  return (
    <Section id="traction" className="border-t border-white/5">
      ...
      <div className="rounded-2xl border border-white/10 bg-white/[0.03] p-6">
        <h3 className="font-medium text-white mb-4 text-sm">
          Target pipeline (discussion stage — no pilots signed yet)
        </h3>
        <div className="space-y-3">
          {[
            ...
            >
              ...
              <span
                className={`text-xs font-medium px-2 py-1 rounded-full ${p.stage.includes("Demo") ? "bg-[#A16207]/10 text-[#A16207]" : "bg-white/5 text-white/40"}`}
              >
                {p.stage}
              </span>
            </div>
...
function BusinessModel() {
  return (
    <Section id="business" className="border-t border-white/5">
      ...
      <div className="grid lg:grid-cols-2 gap-6">
        <div className="rounded-2xl border border-white/10 bg-white/[0.03] p-6">
          ...
          <div className="space-y-4">
            {[
              {
                name: "Hospital OS — SaaS",
                model: "₹50K–₹5L/month per hospital",
                desc: "Tiered by bed count + modules",
                icon: Building2,
              },
              {
                name: "Clinic OS — SaaS",
                model: "₹2K–₹15K/month per clinic",
                desc: "Tiered by doctor count",
                icon: Stethoscope,
              },
              {
                name: "Pharmacia — SaaS + transaction",
                model: "₹1K–₹8K/month + 0.5% on UPI",
                desc: "Per pharmacy + payment fees",
                icon: Pill,
              },
              {
                name: "Patient Portal — Freemium",
                model: "Free for patients",
                desc: "Monetize via blood test + teleconsult",
                icon: HeartPulse,
              },
              {
                name: "Blood Test at Home",
                model: "₹199–₹2,999 per test",
                desc: "30% margin after phlebotomist + lab",
                icon: Activity,
              },
              {
                name: "AI API (B2B)",
                model: "₹0.50–₹5 per AI call",
                desc: "Symptom checker, Rx OCR, lab interpretation",
                icon: Brain,
              },
            ].map((r, i) => (
              <div
      ...
      <Link
        href="/pricing"
        className="mt-6 inline-flex items-center gap-1.5 text-sm font-medium text-[#A16207] hover:text-[#D9B87C]"
      >
        ...
        {[
          {
            ...
            name: "Hospital OS",
            href: "/hospital",
            desc: "18 modules — OPD, IPD, OT, EHR, Nursing, Lab, Radiology, Blood Bank, Billing, Insurance, AI Assistant. ABDM-ready · NABH-aligned.",
            badge: "Flagship",
            color: "#B8860B",
          },
          {
            ...
            name: "Clinic OS",
            href: "/clinic",
            desc: "SOAP consultation, drug autocomplete (54 Indian medicines), ABHA lookup (simulated), public booking page.",
            badge: "New",
            color: "#A16207",
          },
          {
            ...
            name: "Pharmacia",
            href: "/pharmacy",
            desc: "Voice billing, prescription OCR, GST e-invoice, Schedule H register, predictive analytics.",
            badge: "New",
            color: "#F59E0B",
          },
          {
            ...
            name: "Patient Portal",
            href: "/portal",
            desc: "Unified health record. Blood test at home with phlebotomist visit + AI report interpretation.",
            badge: "New",
            color: "#0EA5E9",
          },
          {
            ...
            name: "Connect",
            href: "/connect",
            desc: "Doctor-patient chat, voice, video. Auto-connects when consultations complete or triage flags urgency.",
            color: "#10B981",
          },
          {
            icon: Sparkles,
            ...
            desc: "15 AI tools — symptom checker, derma scan, X-ray reader, diet planner, lab analyzer.",
            color: "#9DB89E",
          },
        ].map((p, i) => (
          <motion.div
          ...
          >
            <Link
              href={p.href}
              className="group block rounded-2xl border border-white/10 bg-white/[0.03] p-5 hover:bg-white/[0.06] transition-all hover:-translate-y-0.5"
            >
  ...
  return (
    <Section id="competitive" className="border-t border-white/5">
        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="border-b border-white/10">
              <th className="text-left py-3 px-2 text-white/40 font-medium text-xs uppercase tracking-wider">
                Capability
              </th>
          ...
          <tbody className="divide-y divide-white/5">
            {[
              ...
              {
                cap: "AI lab report interpretation",
                nexura: true,
                insta: false,
                apollo: false,
                practo: false,
              ...
              {
                cap: "Doctor-patient chat/voice/video",
                nexura: true,
                insta: false,
                apollo: true,
                practo: true,
              ...
              {
                cap: "Schedule H + NABH compliance",
                nexura: true,
                insta: true,
                apollo: false,
                practo: false,
              ...
              <tr key={i} className="hover:bg-white/[0.02]">
                ...
                <td className="text-center py-2.5 px-2">
                  {row.nexura ? (
                    <CheckCircle2 className="h-4 w-4 text-[#A16207] mx-auto" />
                  ) : (
                ...
                <td className="text-center py-2.5 px-2">
                  {row.insta ? (
                    <CheckCircle2 className="h-4 w-4 text-white/40 mx-auto" />
                  ) : (
                    <span className="text-white/20">—</span>
                  )}
                </td>
      ...
      <p className="mt-4 text-xs text-white/40">
        Nexura OS is the only platform that combines hospital + clinic + pharmacy + patient + AI +
        blood testing into one unified ecosystem. Competitors do one thing. We do everything.
      </p>
    </Section>
  );
}
        ...
        {[
          {
            ...
            status: "In progress",
            desc: "ABHA ID integration, health record exchange, ABDM-compliant APIs",
            icon: Shield,
            color: "#A16207",
          },
          {
            ...
            status: "Built-in",
            desc: "Patient consent, data localization, right to erasure, audit trail",
            icon: Shield,
            color: "#9DB89E",
          },
          {
            ...
            desc: "Quality indicators, patient safety, infection control tracking",
            icon: Shield,
            color: "#C9962E",
          },
          {
            ...
            status: "Built-in",
            desc: "Schedule H/H1 register, drug traceability, pharmacovigilance",
            icon: Shield,
            color: "#B8860B",
          },
          {
            ...
            status: "Built-in",
            desc: "TPA claims workflow, cashless pre-auth, claim status tracking",
            icon: Shield,
            color: "#0EA5E9",
          },
          {
            name: "GST e-Invoice",
            status: "Built-in",
            desc: "IRN-ready JSON, CGST/SGST split, HSN codes, e-way bill",
            icon: Shield,
            color: "#F59E0B",
          },
        ].map((c, i) => (
    ...
    <Section id="roadmap" className="border-t border-white/5">
      ...
      <div className="space-y-4">
        {[
          {
            phase: "Q1 2026",
            title: "Seed + Pilot Validation",
            items: [
              "3 hospital pilots in discussion",
              "10 clinic conversations in pipeline",
              "Pharmacy POS beta with 5 stores",
              "ABDM integration in progress",
            ],
            status: "current",
          },
          {
            phase: "Q2 2026",
            title: "Product Depth + AI",
            items: [
              "HL7/FHIR integration",
              "Voice-to-SOAP for doctors",
              "AI drug interaction checker",
              "Patient Portal v2 with wearable sync",
            ],
            status: "next",
          },
          {
            ...
            items: [
              ...
              "200 clinics live",
              "Telemedicine marketplace launch",
              "Series A: $25M raise",
            ],
            status: "planned",
          },
          {
            phase: "Q4 2026",
            title: "Multi-city + Insurance",
            items: [
              "Mumbai + Delhi + Bangalore + Chennai",
              "Insurance claims automation (IRDAI)",
              "Phlebotomist network (500+ cities)",
              "NABH accreditation for partners",
            ],
            status: "planned",
          },
          {
            phase: "Q1-Q2 2027",
            title: "Marketplace + API Platform",
            items: [
              "Open AI API for healthcare",
          ...
          >
            <div className="flex flex-col items-center">
              <span
                className={`grid h-10 w-10 place-items-center rounded-full border-2 shrink-0 ${r.status === "current" ? "bg-[#A16207] border-[#A16207] text-white" : r.status === "next" ? "border-[#A16207] text-[#A16207]" : "border-white/20 text-white/40"}`}
              >
                {r.status === "current" ? (
            ...
            <div className="flex-1 pb-6">
              <div className="flex items-center gap-2 mb-1">
                <p className="text-xs font-semibold text-[#A16207] uppercase tracking-wider">
                  {r.phase}
                </p>
                {r.status === "current" && (
                  <span className="text-[0.5rem] font-bold uppercase px-1.5 py-0.5 rounded-full bg-[#22C55E] text-white">
                    Now
                  </span>
                )}
              </div>
        ...
        {[
          {
            name: "Arpit Nayan",
            role: "Founder & CEO",
            desc: "Full-stack architect. Built Nexura OS from zero — 8 products, 145 data models, 172 API endpoints.",
            initials: "AN",
            color: "#A16207",
          },
          {
            role: "CTO (hiring)",
            desc: "Will lead engineering scale-up. Targeting ex-Practo/Innovaccer/Cerner.",
            initials: "CT",
            color: "#9DB89E",
            hiring: true,
          },
          {
            role: "Head of Compliance (hiring)",
            desc: "Will own ABDM + NABH + DPDP certification. Targeting ex-NHA/IRDAI.",
            initials: "HC",
            color: "#C9962E",
            hiring: true,
          },
          {
            role: "VP Sales (hiring)",
            desc: "Will lead hospital + clinic GTM. Targeting ex-Insta/Apollo/Practo.",
            initials: "VS",
            color: "#B8860B",
            hiring: true,
          },
          ...
          >
            <div className="flex items-center gap-3">
              <span
                className="grid h-12 w-12 place-items-center rounded-full font-display font-bold text-white"
            ...
            {m.hiring && (
              <span className="mt-2 inline-block text-[0.5rem] font-bold uppercase tracking-wider text-[#A16207] bg-[#A16207]/10 px-2 py-0.5 rounded-full">
                Hiring
              </span>
            )}
          </motion.div>
    ...
    <Section id="ask" className="border-t border-white/5">
      ...
      <div className="rounded-3xl border border-white/10 bg-gradient-to-br from-[#A16207]/10 via-[#C9962E]/5 to-[#7A9A7B]/10 p-8 lg:p-12">
        ...
        <div className="flex flex-wrap items-center gap-3">
          <a
            href="mailto:invest@nexuraai.in"
            className="rounded-full bg-white text-[#0A0A0A] px-5 py-2.5 text-sm font-semibold hover:bg-white/90 transition-colors"
          >
            Request data room →
          </a>
          <a
            href="/pricing"
            className="rounded-full border border-white/20 px-5 py-2.5 text-sm font-semibold text-white hover:bg-white/5 transition-colors"
          >
            See pricing
          </a>
          <a
        ...
        <p className="mt-8 text-xs text-white/30">
          Contact: Arpit Nayan · invest@nexuraai.in · Nexura AI Technologies Pvt. Ltd. · CIN:
          U72900MH2025PTC000001
        </p>
      </div>
    </Section>
  );
      ...
      <div className="mx-auto max-w-5xl flex flex-col sm:flex-row items-center justify-between gap-4">
        <div className="flex items-center gap-2">
          ...
          <span className="text-xs text-white/40">
            © 2026 Nexura AI Technologies Pvt. Ltd. · Built in India 🇮🇳
          </span>
        </div>
