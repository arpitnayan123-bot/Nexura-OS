    ...
    plans: [
      ...
      },
      {
        ...
        features: [
          ...
          "ABDM-ready (alignment in progress)",
          "Priority support",
          "1 hospital location",
        ],
        cta: "Start onboarding",
  ...
  },
  {
    ...
    plans: [
      ...
      },
      {
        ...
        price: "₹8,000",
        period: "/month",
        desc: "Up to 5 doctors",
        features: [
          "Everything in Solo",
          "ABHA lookup (simulated)",
          "AI symptom triage",
          "Telemedicine",
          "Follow-up reminders (call-based)",
          "Revenue analytics",
        ],
        cta: "Start onboarding",
        popular: true,
      },
      {
        ...
        price: "₹15,000",
        period: "/month",
        desc: "Unlimited doctors",
        features: [
          "Everything in Practice",
          "Multi-clinic management",
          "Centralized patient DB",
          "Custom branding",
          "API access",
          "Priority support",
        ],
  ...
  },
  {
    ...
    plans: [
      ...
      },
      {
        ...
        price: "₹8,000",
        period: "/month",
        desc: "Unlimited stores",
        features: [
          "Everything in Pro",
          "Chain-wide analytics",
          "Central procurement",
          "Schedule H audit export",
          "API access",
          "Priority support",
        ],
        cta: "Contact sales",
    ...
    plans: [
      ...
      },
      {
        ...
        features: [
          ...
          "Sample collection",
          "Digital report in 6–24h by panel",
          "AI-assisted report reading",
          "8 test panels available",
        ],
        cta: "Book a test",
        popular: true,
      },
      {
        name: "AI Report Reading",
        price: "Free",
        period: "with report",
        desc: "In the Patient Portal",
        features: [
          "AI-assisted reading of blood reports",
          "Plain-English value explanations",
          "Rule-based fallback summary",
          "Not a diagnosis — share with your doctor",
        ],
        cta: "View in portal",
      },
    ],
      ...
      <header className="sticky top-0 z-30 backdrop-blur-xl bg-[#FAF7F2]/80 border-b border-[#E7E5E4]">
        <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 flex items-center justify-between h-14">
          ...
          <div className="flex items-center gap-4 text-xs">
            <Link href="/investors" className="text-[#5C6A7F] hover:text-[#0F172A]">
              Investors
            </Link>
            <Link href="/" className="text-[#5C6A7F] hover:text-[#0F172A]">
              Product
            </Link>
            <Link href="/portal" className="btn-gold rounded-full px-3 py-1.5 font-medium">
              Patient Portal
            </Link>
          </div>
        </div>
      ...
      <main>
        ...
        <section className="px-4 sm:px-6 lg:px-8 pb-20 border-t border-[#E7E5E4]">
          <div className="mx-auto max-w-3xl pt-16">
            ...
            <h2 className="title-lux text-center text-2xl text-[#0F172A] mb-8">
              ...
              {[
                {
                  ...
                  a: "New deployments start with an onboarding offer — contact us and we'll set up a guided walkthrough with demo data. Trial length and terms are finalised during onboarding.",
                },
                {
                  q: "Can I switch plans later?",
                  a: "Absolutely. You can upgrade or downgrade at any time. Changes take effect immediately and we prorate the difference.",
                },
                {
                  q: "Do you offer discounts for NGOs or government hospitals?",
                  a: "Yes. We offer up to 50% discount for government hospitals, NGO-run clinics, and charitable trusts. Contact sales for details.",
                },
                {
                  q: "Is my data secure?",
                  a: "All data is encrypted in transit (TLS 1.3); at-rest encryption is on the roadmap — see the Compliance page for current status. We're DPDP 2023 compliant and ABDM-ready (alignment in progress, not yet integrated). Hosting in India is planned; processing may route through AI providers today — see the Compliance page.",
                },
                {
                  q: "Do you provide training?",
                  a: "Yes. Every plan includes free onboarding training. Professional and Enterprise plans include dedicated training sessions for your team.",
                },
                {
                  q: "What payment modes do you accept?",
                  a: "Payment modes are finalised during onboarding so they match how your organisation already pays — talk to us about the options, including annual-billing arrangements.",
                },
              ].map((faq, i) => (
        ...
        <section className="px-4 sm:px-6 lg:px-8 pb-20">
          <div className="relative mx-auto max-w-4xl overflow-hidden rounded-3xl bg-gradient-to-br from-[#26221E] via-[#1C1917] to-[#141210] p-8 lg:p-12 text-center text-[#F6F1E7] shadow-[var(--shadow-lux-3)]">
            <div
              aria-hidden
              className="aurora-gold -top-24 left-1/2 h-64 w-[30rem] -translate-x-1/2 opacity-45"
            />
            <h2 className="title-lux relative text-2xl sm:text-3xl">
              Ready to <span className="text-gold-gradient">digitize</span> your healthcare?
            </h2>
            <p className="relative mt-2 text-[#F6F1E7]/75">
              Join the ABDM revolution. Start your onboarding today.
            </p>
            <div className="relative mt-6 flex flex-wrap items-center justify-center gap-3">
              <Link
                href="/hospital"
                className="btn-gold h-11 rounded-full px-5 text-sm font-semibold"
              >
                Explore Hospital OS
              </Link>
              <Link
                href="/portal"
                className="btn-glass-lux h-11 rounded-full border-white/20 bg-white/10 px-5 text-sm font-semibold text-white"
              >
                Patient Portal
              </Link>
            </div>
