...
export function OnlineOrdersModule() {
  return (
    <div className="space-y-4">
      <div><h1 className="font-serif text-2xl font-semibold text-white">Online Orders</h1><p className="text-sm text-[#828894]">Patient uploads prescription → AI reads it → auto-creates order → routes to pharmacy</p></div>
      <div className="grid gap-3 sm:grid-cols-2">
        <div className="rounded-2xl border border-[#1E2228] bg-[#111418] p-5">
          ...
          <p className="mt-1 text-xs text-[#828894]">Patient takes photo of prescription → uploads via public link → appears here instantly with "Online" badge</p>
        ...
        <div className="rounded-2xl border border-[#1E2228] bg-[#111418] p-5">
          ...
          <p className="mt-1 text-xs text-[#828894]">Server-side AI reads the Rx → extracts medicines → checks Schedule H compliance → matches to inventory → creates bill draft</p>
        </div>
      </div>
      <div className="grid place-items-center rounded-2xl border border-dashed border-[#1E2228] py-12 text-center"><ScanLine className="mb-2 h-10 w-10 text-[#1E2228]" /><p className="text-sm text-[#828894]">No online orders yet. Patients can order via the public link.</p></div>
    </div>
  );
}
