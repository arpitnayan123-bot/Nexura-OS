...
const PRODUCTS: Feature[] = [
  {
    ...
    name: "Hospital OS",
    sub: "HMS",
    desc: "22-module hospital operating system — OPD, IPD, OT, EHR, Nursing, Lab, Radiology, Blood Bank, Billing, Insurance, AI Assistant. ABDM-ready with NABH-aligned workflows.",
    icon: Building2,
    accent: "#A16207",
    accent2: "#C88A1F",
    material: "textured",
  ...
  },
  {
    ...
    desc: "Healthcare is Reactive. But Nexura is Predictive. Maps twelve disease-risk domains from symptoms, diet, BMI, fitness, sleep and history — calibrated for Indian bodies, explainable by design.",
    icon: BrainCircuit,
    accent: "#6D28D9",
    accent2: "#8B5CF6",
    material: "aurora",
  ...
  },
  {
    id: "diy",
    name: "Nexura DIY",
    sub: "Your Wellness Roadmap",
    desc: "Tell it like it is — one chat builds a safe, realistic wellness roadmap. Safety screen, honest timeframes, no sign-in needed.",
    icon: Sprout,
    accent: "#4D7C0F",
    accent2: "#65A30D",
    material: "textured",
...
export function FeaturesShowcase() {
  ...
  return (
    <section id="products" className="relative scroll-mt-24 overflow-hidden py-20 lg:py-28">
      ...
      <div
        aria-hidden
        className="pointer-events-none absolute inset-x-0 top-24 -z-10 h-[420px] opacity-[0.45] [mask-image:radial-gradient(60%_60%_at_50%_40%,black,transparent)]"
      >
        <div
      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        ...
        >
          <p className="nx-micro mb-3">Material Atelier · Every surface crafted</p>
          <h2 className="display-md text-foreground">
            One ecosystem. <span className="text-gold-gradient">Every feature.</span>
          </h2>
          <p className="mx-auto mt-4 max-w-xl text-base leading-relaxed text-muted-foreground sm:text-lg">
            13 products and 6 quick actions, built for Indian healthcare — each crafted with its own
            premium finish.
          </p>
        </motion.div>
        ...
        >
          {[
            ...
            <div key={i}>
              ...
              <p className="text-[0.6rem] uppercase tracking-wider text-[#6A6764] mt-0.5">
                {s.label}
              </p>
            </div>
          ))}
...
const matBtnClass = (m: Material, sm = true) => `mat-btn ${sm ? "mat-btn--sm" : ""} mat-btn--${m}`;
...
function FeatureCard({
  ...
  const matVars = {
    "--mat-accent": feature.accent,
    "--mat-accent-2": feature.accent2,
      ...
      {featured ? (
        <SpotlightCard className="flex h-full flex-col justify-between rounded-[1.5rem] p-5 sm:p-6">
          ...
          <div className="mt-6">
            ...
            <p className="relative mt-3 max-w-md text-[0.8rem] leading-relaxed text-muted-foreground">
              {feature.desc}
            </p>
          </div>
