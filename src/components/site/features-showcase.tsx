...
const PRODUCTS: Feature[] = [
  ...
  { id: "predictive", name: "Nexura Predictive", sub: "Predictive Health Intelligence", desc: "A calm, consent-first check-in that notices health signals early, explains what may contribute, and tells you what to do next. Safety screening always runs first.", icon: BrainCircuit, accent: "#7C3AED", href: "/predictive", badge: "AI" },
