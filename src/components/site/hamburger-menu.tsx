...
const PRODUCTS: NavEntry[] = [
  { id: "hospital", name: "Hospital OS", sub: "Flagship · HMS", desc: "18-module hospital operating system — OPD, IPD, OT, EHR, Nursing, Lab, Radiology, Blood Bank, Billing, Insurance, AI Assistant.", icon: Building2, accent: "#C98A7A", href: "/hospital", badge: "Flagship", group: "products" },
  { id: "predictive", name: "Nexura Predictive", sub: "Predictive Health Intelligence", desc: "A calm, consent-first check-in that notices health signals early and tells you what to do next. Safety screening always runs first.", icon: BrainCircuit, accent: "#7C3AED", href: "/predictive", badge: "AI", group: "products" },
  { id: "clinic", name: "Clinic OS", sub: "EMR", desc: "HealthPlix-style EMR with SOAP consultation, drug autocomplete from 54 Indian medicines, ABHA registry, public booking page.", icon: Stethoscope, accent: "#D98B6E", href: "/clinic", badge: "New", group: "products" },
  ...
  { id: "connect", name: "Nexura Connect", sub: "Communication", desc: "Doctor-patient chat, voice & video across all products. Auto-connects when consultations complete.", icon: MessageCircle, accent: "#10B981", href: "/connect", group: "products" },
