...
const PRODUCTS: NavEntry[] = [
  ...
  { id: "predictive", name: "Nexura Predictive", sub: "Predictive Health Engine", desc: "Predicts disease before it catches you — from routine, meals, exercise, sleep and city air. Crisis Radar + Living Twin inside.", icon: BrainCircuit, accent: "#7C3AED", href: "/predictive", badge: "AI", group: "products" },
