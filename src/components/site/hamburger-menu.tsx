...
const PRODUCTS: NavEntry[] = [
  ...
  { id: "clinic", name: "Clinic OS", sub: "EMR", desc: "HealthPlix-style EMR with SOAP consultation, drug autocomplete with interaction guard, ABHA registry, public booking page.", icon: Stethoscope, accent: "#D98B6E", href: "/clinic", badge: "New", group: "products" },
