...
export function FounderTeaser() {
  ...
  return (
    <section className="relative bg-[#08080A] overflow-hidden">
      {/* Ambient glow */}
      <div
        className="pointer-events-none absolute top-0 left-1/2 -translate-x-1/2 h-[500px] w-[500px] rounded-full"
        style={{ background: "radial-gradient(circle, #C8A55B08 0%, transparent 70%)" }}
      />
      {/* Grid */}
      <div
      ...
      <div className="relative mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 py-20 lg:py-28">
        ...
        >
          {/* Eyebrow */}
          <p
            className="text-center text-[0.65rem] font-semibold uppercase tracking-[0.3em] mb-4"
            style={{ color: "#C8A55Bcc" }}
          >
            The Founder
          </p>
          ...
          {/* Headline */}
          <h2
            className="font-display text-center text-2xl sm:text-3xl lg:text-4xl font-semibold leading-[1.2] tracking-tight mb-3"
            style={{ color: "#EDE8DE" }}
          >
          ...
          >
            A student from Bihar. Three months in hospital corridors. One decision that changed
            everything.
          </p>
          ...
          <div className="grid lg:grid-cols-5 gap-6 lg:gap-8 items-center">
            ...
            <div className="lg:col-span-2 flex justify-center">
              <div className="relative">
                <div
                  ...
                  style={{ background: "radial-gradient(circle, #C8A55B12 0%, transparent 70%)" }}
                />
                <div
                ...
                >
                  <div
                    ...
                    style={{
                      background:
                        "linear-gradient(to bottom, transparent 50%, #08080A 100%), linear-gradient(to right, #08080A 0%, transparent 12%, transparent 88%, #08080A 100%)",
                    }}
                  />
                  <img
            ...
            <div className="lg:col-span-3 space-y-5">
              ...
              <div>
                ...
                <p className="text-sm sm:text-base" style={{ color: "#C8A55Bcc" }}>
              ...
              <p
                ...
                style={{ color: "rgba(237,232,222,0.8)" }}
              >
          ...
          {/* Stats strip */}
          <div
            className="mt-12 pt-8 border-t flex items-center justify-center gap-8 sm:gap-12"
            style={{ borderColor: "rgba(237,232,222,0.06)" }}
          >
            <div className="text-center">
              ...
              <p
                className="text-[0.6rem] uppercase tracking-wider mt-0.5"
