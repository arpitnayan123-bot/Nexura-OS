...
- [x] 62 Prisma models
- [x] 50+ API routes
- [ ] ABDM certification (ABHA ID + HIE)
- [ ] HL7/FHIR integration
- [ ] Production auth (JWT + refresh tokens)
...
- [ ] Patient Portal v2 with wearable sync (Apple Health, Google Fit)
- [ ] WhatsApp Business API integration (reminders, reports)
...
- [ ] 15 pharmacies live
- [ ] Blood test at home launched in Mumbai
...
- [ ] Hire 1 mobile engineer (React Native)
...
- [ ] 200 clinics live
- [ ] 100 pharmacies live
- [ ] 4 cities operational (Mumbai, Delhi, Bangalore, Chennai)
- [ ] ₹50L MRR
- [ ] Series A: $25M raise
...
- [ ] Advanced analytics dashboard (hospital admin)
...
- [ ] 500 clinics
- [ ] 300 pharmacies
- [ ] Blood test at home in 4 cities
- [ ] 500+ phlebotomist network
- [ ] ₹2Cr MRR
...
- [ ] Advanced AI: chest X-ray reader, ECG analysis, retinal scan
...
- [ ] 2,000 clinics
- [ ] 1,000 pharmacies
- [ ] International pilot (1 SE Asia country)
- [ ] $10M ARR (₹80Cr)
...
- Series B: $50M raise
- 150+ employees
- Market leader in Indian healthcare SaaS
