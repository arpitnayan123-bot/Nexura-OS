...
async function main() {
  ...
  for (const p of procedures) {
    ...
    await db.tourismProcedure.create({
      data: { hospitalId: hospital.id, ...rest, priceUSDCents: usdToCents(priceUSD), active: true },
    });
  }
  ...
  for (let i = 0; i < Math.min(2, staff.length); i++) {
    await db.tourismCoordinator.create({
      data: {
        ...
        name: staff[i].name,
        phone: staff[i].phone,
        email: `${staff[i].name.split(" ")[0].toLowerCase()}@aarogyahospital.in`,
  ...
  const inquiries = [
    {
      ...
      condition:
        "Chest pain for 3 months, angiography shows triple vessel disease. Ejection fraction 45%.",
    ...
    },
    {
      ...
      condition: "Severe osteoarthritis of right hip, difficulty walking. BMI 28.",
      status: "appointment_booked",
      costUSD: 5800,
      apptDate: new Date(Date.now() + 7 * 86400000),
    },
    {
      name: "Ibrahim Hassan",
      ...
      code: "SA",
      procedure: "IVF Treatment (1 cycle)",
      condition: "Married 5 years, secondary infertility. Wife age 32. Previous 2 failed cycles.",
    ...
    },
    {
      ...
      condition: "Bilateral knee osteoarthritis, left worse. Difficulty climbing stairs.",
      status: "arrived",
      costUSD: 5200,
    ...
    },
    {
      ...
      condition: "Left frontal lobe meningioma, 3cm. Headaches and seizures.",
      status: "treatment_ongoing",
      costUSD: 7500,
      arrivalDate: new Date(Date.now() - 5 * 86400000),
    },
    {
      name: "Maria Santos",
      ...
      condition: "BMI 42, type 2 diabetes, hypertension. Failed conservative management.",
      status: "new",
    },
    {
      name: "Mohammed Yusuf",
      ...
      condition: "End stage renal disease, on dialysis for 2 years. Donor: brother.",
      status: "new",
    },
    {
      name: "Aisha Abdullah",
      ...
      code: "OM",
      procedure: "IVF Treatment (1 cycle)",
      condition: "PCOS, married 3 years, primary infertility.",
      status: "discharged",
      costUSD: 2200,
      arrivalDate: new Date(Date.now() - 30 * 86400000),
      dischargeDate: new Date(Date.now() - 25 * 86400000),
      outcome: "successful",
      totalBilled: 2450,
    },
  ];
    ...
    await db.tourismInquiry.create({
      data: {
        ...
        messages: JSON.stringify([
          {
            from: "patient",
            text: `I am interested in ${inq.procedure}. ${inq.condition}`,
  ...
  const testimonials = [
    {
      ...
      rating: 5,
      text: "The entire journey from inquiry to discharge was seamless. The cost estimate was transparent and the surgery was successful. Dr. Rajesh and his team saved my life.",
      date: "Jun 2026",
      verified: true,
    },
    {
      ...
      rating: 5,
      text: "I saved 70% compared to UK private hospitals and got better care. The international desk arranged everything — visa, airport pickup, translator, accommodation.",
      date: "May 2026",
      verified: true,
    },
    {
      ...
      rating: 4,
      text: "Excellent medical care. Arabic-speaking coordinator made me feel comfortable. The follow-up via video consultation after I returned home was very helpful.",
      date: "Apr 2026",
      verified: true,
    },
    {
      ...
      procedure: "Brain Tumor Surgery",
      rating: 5,
      text: "I was told the surgery wasn't possible in my country. Aarogya Hospital gave me a second chance at life. Forever grateful.",
      date: "Mar 2026",
      verified: true,
    },
  ];
